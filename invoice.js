var AppsScriptLink = "AKfycbzgvvFCu4NgK3zXO6CmJae5P_XWw91hqhJ3W4WAjrBnoufEQqBLnbKJvmJaKj3E81c";
...
{
        $.getJSON("https://script.google.com/macros/s/AKfycbzgvvFCu4NgK3zXO6CmJae5P_XWw91hqhJ3W4WAjrBnoufEQqBLnbKJvmJaKj3E81c/exec?page=dropdown",
...
function MaxInv()
{
        $.getJSON("https://script.google.com/macros/s/AKfycbzgvvFCu4NgK3zXO6CmJae5P_XWw91hqhJ3W4WAjrBnoufEQqBLnbKJvmJaKj3E81c/exec?page=max",
        function (data) {
...
function Search(pNo="")
{
        ...
        $.getJSON("https://script.google.com/macros/s/AKfycbzgvvFCu4NgK3zXO6CmJae5P_XWw91hqhJ3W4WAjrBnoufEQqBLnbKJvmJaKj3E81c/exec?page=search&no="+no,
        function (data) {
...
function ShowAllData()
{
	$(document).ready(function (){
		...
		$.getJSON("https://script.google.com/macros/s/AKfycbzgvvFCu4NgK3zXO6CmJae5P_XWw91hqhJ3W4WAjrBnoufEQqBLnbKJvmJaKj3E81c/exec?page=all",
        function (data) {
